...
const ElectronicsCard = ({
  ...
  return (
    <div
      className="flex flex-col items-left justify-left gap-3 w-[230px] h-[400px] border rounded-2xl shadow-sm p-3 hover:shadow-md transition-shadow"
      role="group"
      aria-label={`Electronics card for ${name}`}
    >
