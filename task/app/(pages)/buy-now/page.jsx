...
export default function BuyNowPage() {
  ...
  const billDetails = useMemo(() => {
    ...
    const taxAmount = Math.round((subtotal - discountAmount) * 0.18 * 100) / 100; // 18% GST on (subtotal - discount)
    ...
    return {
      ...
      savings: {
        label: "Total savings",
        amount: savings + deliveryFeeOriginal + discountAmount,
        icon: <HandCoins />,
      },
      grandTotal: {
        label: "Grand Total",
    ...
    <div className="flex flex-col md:flex-row">
      <div className="flex-1">
        ...
        <div className="p-3 md:p-6 w-full max-w-[1700px] mx-auto">
          ...
          {/* Hotel Order Summary */}
          <HotelOrderSummary items={selectedItems} className="mt-6" />
          ...
          {billDetails && (
            <div className="p-4 bg-white shadow rounded-lg mt-6">
              ...
              <div className="mb-4">
                <DiscountCodeInput
                  cartDetails={{
                    total_amount: billDetails.subTotal.amount,
                    items: selectedItems.map(item => ({
