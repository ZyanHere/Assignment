  ...
  return (
    <div className="flex-1">
      ...
      <div className="p-6 w-full max-w-[1700px] mx-auto">
        ...
        <div className="mt-6 max-w-7xl mx-auto rounded-2xl overflow-hidden aspect-[3/1] sm:aspect-[3.5/1] md:aspect-[4/1] relative">
          <Image
        ...
        <div className="mt-8 max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold uppercase mb-4 sm:text-md">{event.title}</h1>
