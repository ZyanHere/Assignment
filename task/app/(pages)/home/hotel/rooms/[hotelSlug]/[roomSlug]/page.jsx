        ...
        <div className="absolute top-[500px] left-0 w-full px-6 pb-10">
          <div className="bg-white rounded-t-4xl shadow-lg p-10">
            <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center">
              ...
              <div className="flex items-center">⭐ <span className="ml-1 text-xl font-semibold">{room.rating}</span></div>
            </div>
            <div className="mb-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="flex flex-col items-center">
                  <Image src="/hotels/rest.svg" alt="Restaurant" width={40} height={40} />
                  <p className="text-sm mt-2">Restaurant</p>
                </div>
                <div className="flex flex-col items-center">
                  <Image src="/hotels/pool.svg" alt="Swimming Pool" width={40} height={40} />
                  <p className="text-sm mt-2">Swimming Pool</p>
                </div>
                <div className="flex flex-col items-center">
                  <Image src="/hotels/Front-Desk.svg" alt="24-Hours Front Desk" width={40} height={40} />
                  ...
                  {facilitiesData.reviews.map((review) => (
                    <div key={review.id} className="border p-4 rounded-md shadow-sm">
                      <div className="flex justify-between items-center space-x-2">
                        ...
                        <span className="ml-2 text-md">⭐ {review.rating} / 5</span>
                      </div>
